...
export function formatModelStatus(
    ...
    return [
        '会话模型',
        '',
        `当前模型: ${currentModel || defaultModel || 'runtime 默认模型'}`,
        `默认模型: ${defaultModel || 'runtime 默认模型'}`,
        `当前 Reasoning effort: ${currentReasoningEffort || defaultReasoningEffort || 'runtime 默认值'}`,
        `默认 Reasoning effort: ${defaultReasoningEffort || 'runtime 默认值'}`,
        '',
